...
function Test_Bench_makechildren (container) {
      var child1 = new HTML_Button (container, "HTML Button");
        ...
        var child6 = new Order_Taker (container, "Order Taker");
      var children = [ {name: "HTML Button", runnable: child1}, {name: "Input Text", runnable: child2}, {name: "junk1", runnable: child3}, {name: "junk2", runnable: child4}, {name: "junk3", runnable: child5}, {name: "Order Taker", runnable: child6} ];
      return children;
}

function Test_Bench_makeconnections (container) {
    var conn7 = {sender:{name: "HTML Button", etag: "click"}, net: "NIY", receivers:  [{name: "junk1", etag: "go"}] };
    var conn8 = {sender:{name: "HTML Button", etag: "click"}, net: "NIY", receivers:  [{name: "junk2", etag: "go"}] };
    var conn9 = {sender:{name: "HTML Button", etag: "click"}, net: "NIY", receivers:  [{name: "junk3", etag: "text1"}] };
    var conn10 = {sender:{name: "junk1", etag: "text"}, net: "NIY", receivers:  [{name: "_me", etag: "food order"}] };
    var conn11 = {sender:{name: "junk2", etag: "text"}, net: "NIY", receivers:  [{name: "_me", etag: "food order"}] };
    var conn12 = {sender:{name: "junk3", etag: "text"}, net: "NIY", receivers:  [{name: "_me", etag: "food order"}] };
    var connections = [ conn7, conn8, conn9, conn10, conn11, conn12 ];
    return connections;
}
...
function Order_Taker_makechildren (container) {
      var child13 = new Phrase_Parser (container, "Phrase Parser");
      var children = [ {name: "Phrase Parser", runnable: child13} ];
      return children;
}

function Order_Taker_makeconnections (container) {
    var conn14 = {sender:{name: "Phrase Parser", etag: "order no choices"}, net: "NIY", receivers:  [{name: "_me", etag: "food order"}] };
    var conn15 = {sender:{name: "Phrase Parser", etag: "order with choices"}, net: "NIY", receivers:  [{name: "_me", etag: "food order"}] };
    var conn16 = {sender:{name: "Phrase Parser", etag: "parse error"}, net: "NIY", receivers:  [{name: "_me", etag: "food order"}] };
    var conn17 = {sender:{name: "Phrase Parser", etag: "hook error"}, net: "NIY", receivers:  [{name: "_me", etag: "food order"}] };
    var conn18 = {sender:{name: "_me", etag: "phrase"}, net: "NIY", receivers:  [{name: "Phrase Parser", etag: "phrase"}] };
    var connections = [ conn14, conn15, conn16, conn17, conn18 ];
    return connections;
}
